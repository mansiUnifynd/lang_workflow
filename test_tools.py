...
# def push_theme(state: ThemeState):
#     os.makedirs(state["directory"], exist_ok=True)

#     cmd = ["shopify", "theme", "push", "--store", state["store"]]
#     print(f"🔼 Running: {' '.join(cmd)} in {state['directory']}")

#     process = subprocess.Popen(cmd, cwd=state["directory"])
#     process.wait()
...
#     # Environment setup
#     os.environ["OPENAI_API_KEY"] = "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"
...
#     # Set up MCP client with html.to.design
#     client = MultiServerMCPClient(
#         {
#             "html.to.design": {
#                 "command": "uvx",
...
#                     "/Users/macbookair-unifynd/langgraph-workflow"
#                 ],
#                 "transport": "stdio"
#             }
#         }
...
#     print("MCP client initialized, discovering tools...")
...
#             print("Processing...")
#             design_response = await graph.ainvoke({"messages": chat_history})

#             # Append assistant reply to history
#             assistant_msg = design_response["messages"][-1]
#             chat_history.append(assistant_msg)
